...
class BertAdam(Optimizer):
    ...
    def get_lr(self):
        ...
        lr = []
        # to change it adapting params partly updated mode  -- only update classifier part
            ...
            for p in group['params'] :
                if p.requires_grad==True:
                    ...
                    if group['t_total'] != -1:
                        ...
                        lr_scheduled = group['lr'] * schedule_fct(float(state['step']/group['t_total']), group['warmup'])
                    else:
